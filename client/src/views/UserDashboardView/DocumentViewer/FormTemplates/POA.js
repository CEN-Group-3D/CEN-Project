	...
	render() {
		return (
			<div>		
				...
				<hr></hr>
				<p>I, <u>{this.props.personal.name}, {this.props.personal.address}</u>, the undersigned, hereby appoint and make <u>{this.props.personal.agent}, {this.props.personal.agent_Address}</u> as my attorney­-in-­fact who shall have full power and authority to represent me and act on my behalf for ONLY the following matters:</p>
				<p><u>{this.props.personal.POA_Matters} </u></p>
				<p><u>{this.props.personal.POA_Matters}</u></p>
				<p><u>{this.props.personal.POA_Matters} </u></p>
				<p><u>{this.props.personal.POA_Matters }</u></p>
				...
				<p>State of <u>{this.props.personal.state}</u>, <u>{this.props.personal.country}</u></p>
			</div>
		)
	}
}
