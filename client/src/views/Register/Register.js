    ...
    render() {
        return (
            <div className='panel container' id="login-panel">
                ...
                <form method="POST" className="login-form needs-validation" noValidate>
                    {/* {
                        this.state.error ? 
                    ...
                    <div className="form-group login-field">
                        ...
                        <input required minLenght="6" className="form-control" type="password" id="password" name="password"></input>
