...
var personalAndFamilySchema = new Schema({
        ...
        marital-status: {type: String, required: false, default: null},
        ...
        religious-affiliation: {type: String, required: false, default: null},
        military-service: {type: Boolean, required: false, default: null},
        education: {type: String, required: false, default: null},
        org-date: {type: Date, required: false, default: null},
